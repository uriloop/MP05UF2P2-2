...
class HashTableTest {
    ...
    void updates() {
        ht = new HashTable();
        ht.put("1", "1");
        ht.put("1", "0");    // Inserir un elements que ja existeix (update) sobre un element que no col·lisiona dins una taula buida.
        ht.put("0", "0");
        ht.put("0", "00");    // Inserir un elements que ja existeix (update) sobre un element que no col·lisiona dins una taula no buida.
        ht.put("11", "11");
        ht.put("11", "00");  //  Inserir un elements que ja existeix (update) sobre un element que si col·lisiona (2a posició) dins una taula no buida.
        ht.put("22", "22");
        ht.put("22", "00");//   Inserir un elements que ja existeix (update) sobre un element que si col·lisiona (3a posició) dins una taula no buida.
        Assertions.assertEquals(ht.toString(), "\n bucket[0] = [0, 00] -> [11, 00] -> [22, 00]\n" +
                " bucket[1] = [1, 0]");
