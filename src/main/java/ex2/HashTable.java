    ...
    public String get(String key) {
        ...
        if(entries[hash] != null) {
            ...
            while( !temp.key.equals(key)) {
                if (temp.next==null) return null;   // ****    afegit pert evitar el nullpointerexception i per que retorni null quan la posició està plena pero l'element no existeix
                temp = temp.next;
            }
        ...
        if(entries[hash] != null) {
            ...
            if(!noExisteix){
                if (temp.prev == null && temp.next == null){    //*** cas element únic
                    entries[hash] = null;
                }else if(temp.prev==null&& temp.next!=null){     //*** cas element colisionant en primera posicio
                    entries[hash]=temp.next;
                    temp.next.prev=null;
                }else if (temp.prev!=null&& temp.next==null){     //*** cas element colisionant en última posicio
                    temp.prev.next=null;
