...
public class HashTable {
     ...
     */
    public void put(String key, Object value/*String value*/) {
        ...
        if(entries[hash] == null) {
            ...
            temp=getHashEntryByKey(key,temp);
            if(temp==null){       //***
                // en cas de fer un insert
                temp=entries[hash];
    ...
    public /*String */Object get(String key) {
        ...
        if(entries[hash] != null) {
            ...
            /*while( !temp.key.equals(key)) {  // ****    afegit per evitar el nullpointerexception i per que retorni null quan la posició està plena pero l'element no existeix
                if (temp.next==null) break;     //  comprovem que existeix
                temp = temp.next;
            }*/
            temp=getHashEntryByKey(key,temp);
            if (temp!=null)
    ...
    public void drop(String key) {
        ...
        if(entries[hash] != null) {
            ...
            if(temp!=null){
                ...
                if (temp.prev == null && temp.next == null){    //*** cas element únic
                    entries[hash] = null;
                }else if(temp.prev==null){     //*** cas element colisionant en primera posicio
                    entries[hash]=temp.next;
                    temp.next.prev=null;
                }else if (temp.next==null){     //*** cas element colisionant en última posicio
                    temp.prev.next=null;
                }else {      //*** cas element colisionant intermig
                    temp.prev.next=temp.next;
                    temp.next.prev=temp.prev;
                }
                ITEMS--;        // *** Afegit per a que resti items quan esborrem elements
    ...
    private HashEntry getHashEntryByKey(String key, HashEntry temp) {
